 ...
 *
 * ```
 * var TestHelper = module.exports = require('bpmn-js-7/test/helper').default;
 *
 * var fs = require('fs');
 *
 * // insert diagram.css
...
var Modeler = require('bpmn-js-7/lib/Modeler').default,
    Viewer = require('bpmn-js-7/lib/Viewer').default;
